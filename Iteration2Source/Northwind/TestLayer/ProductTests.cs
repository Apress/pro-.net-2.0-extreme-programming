...
namespace TestLayer
{
	...
	public class ProductTests
	{
        ...
        public void TestUpdateProductQuantity()
        {
            ...
            Product product = ProductData.GetProduct(productID);
            product.Quantity = 5;
            ProductData.UpdateQuantity(product);

            product = ProductData.GetProduct(productID);

            Assert.AreEqual(quantityOrdered, product.Quantity, "Product Quantity was not not correct.");
        }
    }
}
